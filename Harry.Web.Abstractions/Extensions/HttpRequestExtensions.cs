...
namespace Harry.Web.Extensions
{
    public static class HttpRequestExtensions
    {
        ...
        public static string GetRemoteIP(this HttpRequest request)
        {
            ...
            if ("::1".Equals(ip, StringComparison.Ordinal))
            {
                ip = "127.0.0.1";
            }
            return ip;
        ...
        /// <summary>
        /// 获取Get_X_Forwarded_For原始值(此地址不安全,可在客户端任意设置)
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static string Get_X_Forwarded_For(this HttpRequest request)
        {
        ...
        /// <summary>
        /// 获取X_Forwarded_For里面的地址列表(只返回标准ipv4地址列表)
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        public static string[] Get_X_Forwarded_For_IPs(this HttpRequest request)
        {
            string str = request.Get_X_Forwarded_For();
